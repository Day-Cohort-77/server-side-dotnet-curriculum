...
You'll be working in two separate repos for the project. Your team will receive a Slack message that will contain the URLs for both the client side and server side repositories.

1. Create a directory that will hold both github repos _(e.g. `~/workspace/csharp/rare`)_.
