...
This structure makes it easy to find and modify endpoints related to specific functionality.

## Creating the AuthEndpoints Class

Let's create our authentication endpoints class. Create a new file called `Endpoints/AuthEndpoints.cs`:
...
Organizing endpoints by functionality offers several benefits:

1. **Better organization** - Endpoints are grouped by functionality, making it easier to find and modify them.
2. **Improved maintainability** - Each functionality's endpoints are contained in a single file, reducing the complexity of `Program.cs`.
...
In this chapter, we've learned how to organize our authentication and order endpoints using extension methods. This approach helps keep our code clean, maintainable, and scalable as our application grows.

In the next chapters, we'll continue building our API by implementing specific endpoints for authentication and orders.

Up Next: [User Registration and Login](./auth-registration-login.md)
